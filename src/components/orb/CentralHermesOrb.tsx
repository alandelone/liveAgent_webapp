...
export const CentralHermesOrb: React.FC<CentralHermesOrbProps> = ({
  ...
  const renderIcon = () => {
    ...
    switch (state) {
      ...
      case "executing":
        return (
          <Cog
            className="w-12 h-12 text-blue-300 animate-spin"
  ...
  return (
    <div
      ...
      data-testid="central-hermes-orb"
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        <div
          ...
          style={{
            ...
            opacity: isListening
              ? Math.max(0.25, vol * 0.85)
              : Math.max(0.12, vol * 0.85),
        ...
        <div
          ...
          style={{
            ...
            opacity: isListening
              ? Math.max(0.15, vol * 0.65)
              : Math.max(0.08, vol * 0.65),
        ...
        <div
          ...
          style={{
            ...
            opacity: isListening
              ? Math.max(0.08, vol * 0.45)
              : Math.max(0.04, vol * 0.45),
      ...
      <button
        ...
        data-audio-level={vol.toFixed(4)}
      >
      ...
      <div className="mt-6 text-center max-w-xs transition-opacity duration-200">
        ...
        {statusText && (
          <p
            className="text-xs text-slate-400 mt-1.5 truncate px-2"
            title={statusText}
          >
            {statusText}
          </p>
